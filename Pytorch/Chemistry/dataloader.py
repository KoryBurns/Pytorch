...
from Pytorch.Chemistry.save import load_csv_files
from Pytorch.Chemistry.save import load_sdf_files
from Pytorch.Chemistry.save import encode_fasta_sequence
from Pytorch.Chemistry.feature import UserDefinedFeaturizer
from Pytorch.Chemistry import DiskDataset


def convert_df_to_numpy(df, tasks, verbose=False):
  """Transforms a dataframe containing pytorch input into numpy arrays"""
