...
class TestDNASim(unittest.TestCase):
  ...
  def test_motif_density_localization_simulation(self):
    ...
    sequences, y, embed = pc.molnet.simulate_motif_density_localization(
        **params)
  ...
  def test_motif_counting_simulation(self):
    ...
    sequences, y, embed = pc.molnet.simulate_motif_counting(**params)
    assert sequences.shape == (60,)
    assert y.shape == (60, 1)
  ...
  def test_simple_motif_embedding(self):
    ...
    sequences, embed = pc.molnet.simple_motif_embedding(**params)
  ...
  def test_motif_density(self):
    ...
    sequences, embed = pc.molnet.motif_density(**params)
    assert sequences.shape == (30,)
  ...
  def test_single_motif_detection(self):
    ...
    sequences, y, embed = pc.molnet.simulate_single_motif_detection(**params)
    assert sequences.shape == (60,)
    assert y.shape == (60, 1)
