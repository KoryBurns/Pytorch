...
from Pytorch.Chemistry.data import Dataset, pad_features
from Pytorch.Chemistry.trans import undo_transforms
from Pytorch.Chemistry.utils.save import load_from_disk
from Pytorch.Chemistry.utils.save import save_to_disk
from Pytorch.Chemistry.utils.save import log
from Pytorch.Chemistry.utils.evaluate import Evaluator
...
class Model(BaseEstimator):
  ...
  def evaluate(self, dataset, metrics, transformers=[], per_task_metrics=False):
    ...
    Parameters
    ----------
    dataset: Pytorch.Chemistry.data.Dataset
      Dataset object.
