...
import torch
from Pytorch.Chemistry.models.tensorgraph import model_ops
from Pytorch.Chemistry.models.tensorgraph.model_ops import get_ndim
...
def prelu(x):
    "parametric relu. wrapper around torch.nn.PReLU"
    return nn.PReLU(x)
